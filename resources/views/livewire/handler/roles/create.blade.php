{{-- Goal: Create role and assign permissions, Livewire: Handler\Roles\Create, Alpine: search --}}
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Buat role baru dan tentukan hak akses perizinan untuk role ini.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Pilih perizinan yang diberikan pada role baru ini</p>
                    </div>
                </div>
                ...
                @forelse ($groupedPermissions as $group => $perms)
                    <div class="rounded-xl border border-zinc-200 p-4 transition-colors dark:border-zinc-800 dark:bg-gray-800/40"
                        x-bind:class="dynamicBg ?
                            'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
                            'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
                        <h4 class="mb-3 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-red-600 dark:text-red-400">
                        ...
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                            @foreach ($perms as $permission)
                                <div class="group/perm flex items-center space-x-2 transition-all duration-200 hover:translate-x-1">
                                    ...
                                    <label
                                        class="cursor-pointer text-sm font-medium text-gray-700 transition-colors group-hover/perm:text-green-600 dark:text-gray-300 dark:group-hover/perm:text-green-400"
