...
<div class="fixed inset-0 z-[100] overflow-y-auto px-4 py-6 sm:px-0" style="display: {{ $show ? 'block' : 'none' }};"
    ...
    <div class="{{ $maxWidth }} mb-6 transform overflow-hidden rounded-xl bg-white shadow-xl ring-1 ring-zinc-200 transition-all dark:bg-dark-primary dark:ring-zinc-800 sm:mx-auto sm:w-full"
